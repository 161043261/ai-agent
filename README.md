...
# Pre-commit hook: 自动格式化 Java 代码
# 使用 fmt-maven-plugin (Google Java Format)

echo "🔄 Running Java code formatter..."
...
# 格式化 yu-image-search-mcp-server 子项目
echo "  Formatting yu-image-search-mcp-server..."
...
if [ $FORMAT_RESULT -ne 0 ]; then
    echo "❌ yu-image-search-mcp-server formatting failed!"
    exit 1
fi
